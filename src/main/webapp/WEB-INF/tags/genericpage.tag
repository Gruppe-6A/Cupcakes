...
<!DOCTYPE html>
<html lang="en">
<body style="background-color:#3c1460" class="text-white">
...
<body>
    ...
    -->
<header class="d-flex flex-column flex-md-row align-items-center p-3 pb-0 px-md-4 mb-4 bg-#3c1460">
    ...
    <img src="${pageContext.request.contextPath}/images/olskercupcakes.png"class="img-fluid mb-4"/>
    <jsp:doBody/>
</div>
